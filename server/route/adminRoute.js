...
router.get('/admin/readbyid/category/:id', getCategoryById);       // Get Category by ID
...
router.put('/admin/update/category/:id', updateCategory);          //Update Category By ID
...
router.delete('/admin/delete/category/:id', deleteCategory);         //Delete A Category By Its ID
